...
def test_kb_chat_v2_review_log_message_uses_current_flow_labels():
    message = KbChatService._build_v2_retrieval_review_log_message(
        state={
            "workflow_id": "kb_chat_v2",
            "query": "如何查看会员的列表",
            "session_id": "3fe1ff08fbae4b2e968894c2ef2a3763",
            "team_id": 1,
            "knowledge_base_id": 18,
            "question_type": "attribute_lookup",
            "retrieval_complexity": "fast",
            "retrieval_required": True,
            "route_reason": "询问具体操作步骤或功能位置",
        },
        result={
            "workflow_id": "kb_chat_v2",
            "log_id": 1,
            "created_at": "2026-05-22 15:20:54",
            "query": "如何查看会员的列表",
            "session_id": "3fe1ff08fbae4b2e968894c2ef2a3763",
            "team_name": "团队A",
            ...
            "retrieval_complexity": "fast",
            "route_reason": "询问具体操作步骤或功能位置",
            "route_trace": {"latency_ms": 0},
            "plan_trace": {"latency_ms": 0},
            "rewrite_trace": {"latency_ms": 2620},
            "retrieval_queries": ["如何查看会员的列表"],
            "candidate_entities": ["会员", "会员列表"],
            "retrieval_trace": {
            ...
            "retrieval_evaluation": {
                "status": "sufficient",
                "next_action": "answer",
                "reason": "Evidence provides navigation path: 会员列表 > 自定义类型Tab > 设置类型.",
            },
            "evaluate_trace": {"latency_ms": 10339},
            "answer_status": "answered",
            "answer_trace": {"confidence": "-", "latency_ms": 15694},
            "feedback_value": None,
            "suggested_review_label": None,
            "review_label": None,
        },
        total_latency_ms=37944,
    )

    assert "1. 问题分析" in message
    assert "3. 检索执行" in message
    assert "5. 答案生成" in message
    assert "9. 审查信息" not in message
    assert "route_latency_ms: 0" in message
    assert "graph_hits: 6" in message
